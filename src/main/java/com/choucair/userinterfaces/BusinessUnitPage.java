...
public class BusinessUnitPage extends PageObject {
    ...
    public static final Target OPTION_ORGANIZATION = Target.the("Opcion oorganizacion")
    ...
    public static final Target NAME_SCROLL = Target.the("Nombre del negocio")
            .locatedBy("//*[contains(text(), 'Public Relations')]");
